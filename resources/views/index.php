...
<html lang="en">
	<head>
		...
		<link href="{{asset('frontendtemplate/Movie channel/fonts/font-awesome.min.css" rel="stylesheet" type="text/css')}}">

    
    <link href="{{ asset('frontendtemplate/Movie channel/style.css')}}" rel="stylesheet">
